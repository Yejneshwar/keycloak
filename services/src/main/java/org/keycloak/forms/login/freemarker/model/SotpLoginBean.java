...
public class SotpLoginBean {
    ...
    public SotpLoginBean(KeycloakSession session, RealmModel realm, UserModel user, String selectedCredentialId) {
        System.out.println("Running SotpLOGINBean!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");


        this.userOtpCredentials = user.credentialManager().getStoredCredentialsByTypeStream(OTPCredentialModel.SOTP)
        ...
        if (selectedCredentialId == null || selectedCredentialId.isEmpty()) {
            SOTPCredentialProvider sotpCredentialProvider = (SOTPCredentialProvider)session.getProvider(CredentialProvider.class, ApplessOTPCredentialProviderFactory.PROVIDER_ID);
            OTPCredentialModel otpCredential = sotpCredentialProvider
    ...
    public static class OTPCredential {
        ...
        public OTPCredential(CredentialModel credentialModel) {
            ...
            this.userLabel = credentialModel.getUserLabel() == null || credentialModel.getUserLabel().isEmpty() ? SOTPFormAuthenticator.UNNAMED : credentialModel.getUserLabel();
        }
