...
public class Constants {
    ...
    static {
        ...
        EXPOSED_LOG_DETAILS.add(Details.UPDATED_PHONE_NUMBER_LOCALE);
        EXPOSED_LOG_DETAILS.add(Details.PHONE_NUMBER_LOCALE);
        EXPOSED_LOG_DETAILS.add(Details.PREVIOUS_PHONE_NUMBER_LOCALE);
        EXPOSED_LOG_DETAILS.add(Details.UPDATED_PHONE_NUMBER);
        EXPOSED_LOG_DETAILS.add(Details.PHONE_NUMBER);
        EXPOSED_LOG_DETAILS.add(Details.PREVIOUS_PHONE_NUMBER);
