...
public enum EventType implements EnumWithStableIndex {
    ...
    UPDATE_PHONE_NUMBER_LOCALE(52, true),
    UPDATE_PHONE_NUMBER_LOCALE_ERROR(0x10000 + UPDATE_PHONE_NUMBER_LOCALE.getStableIndex(), true),
    VERIFY_PHONE_NUMBER(53, true),
    VERIFY_PHONE_NUMBER_ERROR(0x10000 + VERIFY_PHONE_NUMBER.getStableIndex(), true),
    UPDATE_PHONE_NUMBER(54, true),
    UPDATE_PHONE_NUMBER_ERROR(0x10000 + UPDATE_PHONE_NUMBER.getStableIndex(), true),
    SEND_VERIFY_PHONE_NUMBER(55, true),
